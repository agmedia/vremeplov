<template>
    <div>
        <div class="checkout-summary-card p-4" v-if="route == 'kosarica'">
        ...
        <div class="checkout-summary-card p-4 ms-lg-auto" v-if="route == 'naplata'">
        ...
        <div class="checkout-summary-card p-4 ms-lg-auto" v-if="route == 'pregled'">
            <div class="py-2 px-xl-2">
                <div class="widget mb-3">
