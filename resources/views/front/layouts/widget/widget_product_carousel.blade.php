        ...
        <div class="container">
            <div class="{{ $data['container'] ? 'bg-white rounded-3 shadow-sm px-3 px-md-4 pt-2' : '' }}">
                ...
                <div class="tns-carousel widget-touch-carousel pt-2 pb-3">
                    <div class="tns-carousel-inner" data-carousel-options='{"items":2,"controls":true,"nav":true,"mouseDrag":true,"touch":true,"preventScrollOnTouch":"auto","responsive":{"0":{"items":2,"gutter":8,"controls":false},"500":{"items":2,"gutter":14},"768":{"items":3,"gutter":18},"1100":{"items":5,"gutter":24}}}'>
