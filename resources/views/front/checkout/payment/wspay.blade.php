<form name="pay" class="w-100" action="{{ $data['action'] }}" method="POST">
  ...
  {{--  <input type="hidden" name="PaymentPlan" value="{{ $data['plan'] }}">
    ...
    <div class="d-flex mt-3">
        ...
        <div class="w-50 ps-2"><button class="btn btn-primary d-block w-100" type="submit">Naručite uz obvezu plaćanja<i class="fa-regular fa-arrow-right ms-1"></i></button></div>
    </div>
