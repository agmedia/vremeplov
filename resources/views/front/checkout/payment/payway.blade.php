<form name="pay" class="w-100" action="{{ $data['action'] }}" method="POST">
    ...
    <div class="checkout-payment-actions d-flex mt-3">
        ...
        <div class="w-50 ps-2"><button class="btn btn-primary d-block w-100" type="submit" aria-label="Dovrši narudžbu s obvezom plaćanja">Dovrši narudžbu<i class="fa-regular fa-arrow-right mt-sm-0 ms-1"></i></button></div>
    </div>
