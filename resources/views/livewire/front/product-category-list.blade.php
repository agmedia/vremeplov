<section class="col-lg-8">
    ...
    <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
        <div class="d-flex flex-wrap">
            <div class="dropdown me-2 d-md-none"><button class="btn btn-primary" type="button" data-bs-target="#shop-sidebar" data-bs-toggle="offcanvas" aria-controls="shop-sidebar" aria-label="Otvori filtre"><i class="fa-regular fa-filter" aria-hidden="true"></i></button></div>
      ...
      <!--  <div class="d-flex pb-3"><a class="nav-link-style nav-link-light me-3" href="#"><i class="fa-regular fa-arrow-left"></i></a><span class="fs-md text-light">{{ $products->currentPage() }} / {{ $products->lastPage() }}</span><a class="nav-link-style nav-link-light ms-3" href="#"><i class="fa-regular fa-arrow-right"></i></a></div>-->
